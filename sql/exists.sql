...
CREATE INDEX idx_vendas_i_venda_venda ON vendas (i_venda_venda);
alter table produtovenda add constraint relacao1 foreign key (i_venda_venda) references vendas (i_venda_venda);
...
insert into cliente values (211,'Crisberliston','15935745698','2000-01-01',1);
insert into cliente values (212,'Malgamorson','32165498700','2001-01-01',1);
insert into cliente values (213,'Silmastilda','12345678900','2002-01-01',1);
insert into cliente values (214,'Florasmirtes','14785236911','2003-01-01',1);

select * from cliente;
select * from vendas;

select * from cliente c
where exists(select * from vendas v where v.i_cliente_cliente=c.i_cliente_cliente);
